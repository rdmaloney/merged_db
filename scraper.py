...
def scrape_data():
    ...
    for link in all_links:
        ...
        for row in rows:
            ...
            if odds_f1 > odds_f2:
                favourite.append(fighters[1].text)
            else:
                favourite.append(fighters[0].text)
                
            if odds_f1 < odds_f2:
                underdog.append(fighters[1].text)
            else:
                underdog.append(fighters[0].text)
...
def merge_data(df):
    ...
    morph_api_url = "https://api.morph.io/rdmaloney/fighters_db/data.json"
